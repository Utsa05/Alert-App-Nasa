        ...
        children:   [
          ...
          Padding(
            ...
            child: const SizedBox(
                width: 400,
                child: TextLtdWidget(title:"What severe weather is importent for your to track?",line: 2,color: Colors.white,size: 18,)),
          ),
            ...
            itemBuilder: (BuildContext context, int index) {
              return Padding(
                ...
                child: ListTile(
                  ...
                  leading: Image.asset(allowData[index].icon.toString(),height: 20,width: 20,),
                  title:TextLtdWidget(title: allowData[index].title.toString(),size: 14,color:Colors.white,),
                  trailing: Checkbox(
                    shape: const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(10))), // Rounded Checkbox
                    value: isChecked,
          ...
          SizedBox(
            ...
            child: Row(
              ...
              children: [
                ButtonWidget(onTap: () {  },widget: const TextWidget(title:"Continue",color: Colors.white,weight: FontWeight.bold,),),
              ],
            ),
          ),
